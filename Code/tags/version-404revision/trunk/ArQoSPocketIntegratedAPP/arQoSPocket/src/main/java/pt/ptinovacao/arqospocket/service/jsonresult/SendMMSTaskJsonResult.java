...
public class SendMMSTaskJsonResult extends TaskJsonResult implements ITaskResult, Serializable{
	...
	private final static Logger logger = LoggerFactory.getLogger(SendMMSTaskJsonResult.class);

	private String sent_data;
	private String data_size;

	public SendMMSTaskJsonResult(String task_id, String task_name,
								 ...
								 String data_size, MyLocation taskLocation, EConnectionTechnology execution_in_technology) {
		...
		final String method = "SendMMSTaskJsonResult";
	...
	public Map<String, String> get_task_results(Context context) {
		...
		try {
			...
			task_result_list.put(context.getString(R.string.task_result_sent_data), sent_data);
	...
	public Object clone() {
		...
		try {
			...
			return new SendMMSTaskJsonResult(super.task_id, super.task_name, super.macro_id, super.task_number, super.iccid, 
					super.cell_id, super.loc_gps, super.status, super.dateini, super.datefim, this.sent_data,
					this.data_size, (MyLocation) super.taskLocation.clone(), super.execution_in_technology);
