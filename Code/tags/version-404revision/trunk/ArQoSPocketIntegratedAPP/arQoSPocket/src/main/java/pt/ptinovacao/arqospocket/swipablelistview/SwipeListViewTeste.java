...
public class SwipeListViewTeste extends ListView {
	 ...
	 */
	protected SwipeListViewTouchListenerTeste touchListener;
	 ...
	 *            Front Identifier
	 */
	public SwipeListViewTeste(Context context, int swipeBackView,
			int swipeFrontView) {
		super(context);
	 ...
	 */
	public SwipeListViewTeste(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(attrs);
	}
	 ...
	 */
	public SwipeListViewTeste(Context context, AttributeSet attrs, int defStyle) {
	...
	protected void init(AttributeSet attrs) {
		...
		touchListener = new SwipeListViewTouchListenerTeste(this,
	...
	public void setBaseSwipableListViewListennerTestes(
			BaseSwipableListViewListenerTestes baseSwipableListViewListennerTestes) {
