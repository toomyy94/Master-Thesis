...
public class TurnOFFMobileTaskJsonResult extends TaskJsonResult implements ITaskResult, Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	private final static Logger logger = LoggerFactory.getLogger(TurnOFFWiFiTaskJsonResult.class);

	public TurnOFFMobileTaskJsonResult(String task_id, String task_name,
	...
	public Object clone() {
		...
		try {
			...
			return new TurnOFFMobileTaskJsonResult(super.task_id, super.task_name, super.macro_id, super.task_number, super.iccid, 
