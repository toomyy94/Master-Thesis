...
public class HangUpCallTaskJsonResult extends TaskJsonResult implements ITaskResult, Serializable{
	...
	private final static Logger logger = LoggerFactory.getLogger(HangUpCallTaskJsonResult.class);
	...
	public HangUpCallTaskJsonResult(String task_id, String task_name,
									String macro_id, String task_number, String iccid, String networkInformation,
									String loc_gps, String status, Date dateini, Date datefim, String callDuration,
	...
	public Map<String, String> get_task_results(Context context) {
		...
		try {
			...
			task_result_list.put(context.getString(R.string.task_result_call_duration), callDuration);
	...
	public Object clone() {
		...
		try {
			...
			return new HangUpCallTaskJsonResult(super.task_id, super.task_name, super.macro_id, super.task_number, super.iccid,
					super.cell_id, super.loc_gps, super.status, super.dateini, super.datefim, this.callDuration,
