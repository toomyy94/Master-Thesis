...
public class FragmentHistoricoAnomalias_Pager extends Fragment {

//	private ActivityTestesHistorico activity;
	private ListAwareViewPager viewPager;
	private Adapter_Fragments_Historico_Anomalias adapter;
...
//		this.activity = (ActivityTestesHistorico) activity;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		adapter = new Adapter_Fragments_Historico_Anomalias(
