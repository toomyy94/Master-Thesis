...
public class AnswerVoiceCallTaskJsonResult extends TaskJsonResult implements ITaskResult, Serializable{
	...
	private final static Logger logger = LoggerFactory.getLogger(AnswerVoiceCallTaskJsonResult.class);

	private String iccid;
	private String networkInformation;
	private String callerNumber;
	private final int fixedValue = 1;
	private String timeWaitingForRinging;
	private String audioRecordFileName;

	public AnswerVoiceCallTaskJsonResult(String task_id, String task_name,
										 String macro_id, String task_number, String iccid, String networkInformation,
										 String loc_gps, String status, Date dateini, Date datefim, String callerNumber,
										 String timeWaitingForRinging, String audioRecordFilename,
		...
		final String method = "AnswerVoiceCallTaskJsonResult";
	...
	public String buildTaskJsonResult() {
		...
		try {
			...
			sb.append("\"callerNumber\":\""+callerNumber+"\",");
			sb.append("\"timeWaitingForRinging\":\""+timeWaitingForRinging+"\"");
			sb.append("}");
	...
	public String buildTaskStringResult() {
		...
		try {
			...
			sb.append("|");
			sb.append(timeWaitingForRinging + "|");
		} catch(Exception ex) {
			MyLogger.error(logger, method, ex);
		}
	...
	public String toString() {
		...
		try {
			...
			sb.append("\ntimeWaitingForRinging :"+timeWaitingForRinging);
	...
	public Map<String, String> get_task_results(Context context) {
		...
		try {
			...
			task_result_list.put(context.getString(R.string.task_result_call_origin_number), callerNumber);
			task_result_list.put(context.getString(R.string.task_result_time_waiting_ringing), timeWaitingForRinging);
	...
	public Object clone() {
		...
		try {
			...
			return new AnswerVoiceCallTaskJsonResult(super.task_id, super.task_name, super.macro_id, super.task_number, super.iccid,
					super.cell_id, super.loc_gps, super.status, super.dateini, super.datefim, this.callerNumber, this.timeWaitingForRinging,
