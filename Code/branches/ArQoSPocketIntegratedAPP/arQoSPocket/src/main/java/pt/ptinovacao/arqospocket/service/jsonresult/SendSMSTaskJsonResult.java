...
public class SendSMSTaskJsonResult extends TaskJsonResult implements ITaskResult, Serializable{
	...
	private final static Logger logger = LoggerFactory.getLogger(SendSMSTaskJsonResult.class);

	private String sending_time;
	private String destination;

	public SendSMSTaskJsonResult(String task_id, String task_name,
			String macro_id, String task_number, String iccid, String cell_id,
			String loc_gps, String status, Date dateini, Date datefim, String sending_time, 
			String destination, MyLocation taskLocation, EConnectionTechnology execution_in_technology) {
		...
		final String method = "SendSMSTaskJsonResult";
		...
		try {
			...
			MyLogger.debug(logger, method, "sending_time :"+sending_time);
			MyLogger.debug(logger, method, "destination :"+destination);
	...
	public String get_sending_time() {
		return sending_time;
	}
	...
	public String buildTaskJsonResult() {
		...
		try {
			...
			sb.append("\"sending_time\":\""+sending_time+"\",");
	...
	public Map<String, String> get_task_results(Context context) {
		...
		try {
			...
			task_result_list.put(context.getString(R.string.task_result_sending_time), sending_time);
			task_result_list.put(context.getString(R.string.task_result_destination_number), destination);
	...
	public Object clone() {
		...
		try {
			...
			return new SendSMSTaskJsonResult(super.task_id, super.task_name, super.macro_id, super.task_number, super.iccid, 
					super.cell_id, super.loc_gps, super.status, super.dateini, super.datefim, this.sending_time,
					this.destination, (MyLocation) super.taskLocation.clone(), super.execution_in_technology);
