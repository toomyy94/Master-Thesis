...
public class ReceivedMMSTaskJsonResult extends TaskJsonResult implements ITaskResult, Serializable{
	...
	private final static Logger logger = LoggerFactory.getLogger(ReceivedMMSTaskJsonResult.class);

	private String received_data;
	private String data_size;
	private String source_number;

	public ReceivedMMSTaskJsonResult(String task_id, String task_name,
			...
			String data_size, String source_number, MyLocation taskLocation, EConnectionTechnology execution_in_technology) {
		...
		final String method = "ReceivedMMSTaskJsonResult";
	...
	public Map<String, String> get_task_results(Context context) {
		...
		try {
			...
			task_result_list.put(context.getString(R.string.task_result_received_mms_received_data), received_data);
	...
	public Object clone() {
		...
		try {
			...
			return new ReceivedMMSTaskJsonResult(super.task_id, super.task_name, super.macro_id, super.task_number, super.iccid, 
					super.cell_id, super.loc_gps, super.status, super.dateini, super.datefim, this.received_data,
					this.data_size, this.source_number, (MyLocation) super.taskLocation.clone(), super.execution_in_technology);
