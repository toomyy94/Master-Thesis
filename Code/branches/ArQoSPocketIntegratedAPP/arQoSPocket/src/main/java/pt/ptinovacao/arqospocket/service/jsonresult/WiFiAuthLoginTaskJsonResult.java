...
public class WiFiAuthLoginTaskJsonResult extends TaskJsonResult implements ITaskResult, Serializable{
	...
	private final static Logger logger = LoggerFactory.getLogger(WiFiAuthLoginTaskJsonResult.class);

	private String response_code;
	private String response_time;

	public WiFiAuthLoginTaskJsonResult(String task_id, String task_name,
		...
		final String method = "WiFiAuthLoginTaskJsonResult";
	...
	public Object clone() {
		...
		try {
			...
			return new WiFiAuthLoginTaskJsonResult(super.task_id, super.task_name, super.macro_id, super.task_number, super.iccid, 
