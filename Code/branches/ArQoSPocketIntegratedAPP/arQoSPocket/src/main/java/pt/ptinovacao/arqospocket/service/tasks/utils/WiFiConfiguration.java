...
public class WiFiConfiguration {
	...
	private final static Logger logger = LoggerFactory.getLogger(WiFiConfiguration.class);
	...
	public static void setupSecurity(WifiConfiguration config, String security,
			String password) {
		final String method = "setupSecurity";
		...
		switch (sec) {
			...
			default:
				MyLogger.debug(logger, method, "Invalid security type: " + sec);
		}
	...
	private static PskType getPskType(ScanResult result) {
		...
		if (wpa2 && wpa) {
			...
			MyLogger.debug(logger, method, "Received abnormal flag string: " + result.capabilities);
			return PskType.UNKNOWN;
		}
	}

	public static String getDisplaySecurityString(final ScanResult scanResult) {
