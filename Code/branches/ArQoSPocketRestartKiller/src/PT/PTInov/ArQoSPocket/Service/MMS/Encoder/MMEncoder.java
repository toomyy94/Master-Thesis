  ...
  */
  ...
  public void encodeMessage() throws MMEncoderException {
    ...
    if(!m_bMessageAvailable)
        throw new MMEncoderException("Sem mensagem multimedia no codificador!");
    ...
    try {
      ...
      if(!m_Message.isMessageTypeAvailable()) {
        m_Out.close();
        throw new MMEncoderException("Formato invalido de mensagem multimedia.");
      }
      ...
      switch(nMessageType) {
        ...
        case MESSAGE_TYPE_M_DELIVERY_IND: // ---------------------------- m-delivery-ind
            ...
            if(m_Message.isMessageIdAvailable()) {
              ...
              m_Out.close();
              throw new MMEncoderException ("O campo ID da mensagem multimedia é nulo.");
            }
            ...
            if(m_Message.isDateAvailable()) {
              ...
              if(data == null) {
                m_Out.close();
                throw new MMEncoderException("Erro a codificar a data da mensagem multimedia");
              }
            ...
            if(m_Message.isToAvailable()) {
              ...
              if(sAddress == null) {
                m_Out.close();
                throw new MMEncoderException("O campo TO da mensagem multimedia esta defenido como nulo.");
              }
              ...
              m_Out.close();
              throw new MMEncoderException("Sem destinatario");
            }
          ...
          // ------------------- MESSAGE-STATUS ----------------
            if(m_Message.isStatusAvailable()) {
              ...
              m_Out.write(m_Message.getMessageStatus());
               ...
               m_Out.close();
               throw new MMEncoderException ("O Campo ID da mensagem é nulo.");
            }
