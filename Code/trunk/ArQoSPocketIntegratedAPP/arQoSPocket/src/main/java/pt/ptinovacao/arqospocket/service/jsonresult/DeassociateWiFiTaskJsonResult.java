...
public class DeassociateWiFiTaskJsonResult extends TaskJsonResult implements ITaskResult, Serializable{
	...
	public DeassociateWiFiTaskJsonResult(String task_id, String task_name,
	...
	public Object clone() {
		...
		try {
			...
			return new DeassociateWiFiTaskJsonResult(super.task_id, super.task_name, super.macro_id, super.task_number, super.iccid, 
