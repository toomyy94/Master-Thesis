...
public class ReassociateWiFITaskJsonResult extends TaskJsonResult implements ITaskResult, Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	private final static Logger logger = LoggerFactory.getLogger(ReassociateWiFITaskJsonResult.class);

	public ReassociateWiFITaskJsonResult(String task_id, String task_name,
	...
	public Object clone() {
		...
		try {
			...
			return new ReassociateWiFITaskJsonResult(super.task_id, super.task_name, super.macro_id, super.task_number, super.iccid, 
