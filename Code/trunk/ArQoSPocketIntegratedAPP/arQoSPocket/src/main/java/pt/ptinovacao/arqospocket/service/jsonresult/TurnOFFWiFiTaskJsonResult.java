...
public class TurnOFFWiFiTaskJsonResult extends TaskJsonResult implements ITaskResult, Serializable{
	...
	public TurnOFFWiFiTaskJsonResult(String task_id, String task_name,
	...
	public Object clone() {
		...
		try {
			...
			return new TurnOFFWiFiTaskJsonResult(super.task_id, super.task_name, super.macro_id, super.task_number, super.iccid, 
