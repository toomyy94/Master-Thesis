...
public class GaugeView extends LinearLayout
{
	...
	{
		this.gaugeBackground = R.drawable.velocimetro_rede_movel;
		this.needleBackground = R.drawable.ponteiro45;
	...
	public void setType(GaugeType type)
	{
		...
		switch (type)
		{
			case MobileNetwork2G:
				setGaugeBackgroundResource(R.drawable.velocimetro_2g);
				setNeedleBackgroundResource(R.drawable.ponteiro_sul);
				setValueRange(-140, -25);
				setAngleRange(0, 270);
				break;
			case MobileNetwork3G:
				setGaugeBackgroundResource(R.drawable.velocimetro_3g);
				setNeedleBackgroundResource(R.drawable.ponteiro_sul);
				setValueRange(-140, -25);
				setAngleRange(0, 270);
				break;
			case MobileNetwork4G:
				setGaugeBackgroundResource(R.drawable.velocimetro_4g);
				setNeedleBackgroundResource(R.drawable.ponteiro_sul);
				setValueRange(-140, -25);
				setAngleRange(0, 270);
				break;
			case WifiSignalLevel:
				setGaugeBackgroundResource(R.drawable.wifi_signal_level);
				setNeedleBackgroundResource(R.drawable.ponteiro_sul);
				setValueRange(-90, -5);
				setAngleRange(0, 225);
				break;
			case Mobile_disabled:
				setGaugeBackgroundResource(R.drawable.dashboard_rede_movel_indisponivel);
				setNeedleBackgroundResource(R.drawable.dashboard_ponteiro_disable);
				setValueRange(-115, -75);
				setAngleRange(0, 180);
				break;
			case Wifi_disabled:
				setGaugeBackgroundResource(R.drawable.dashboard_wifi_indisponivel);
				setNeedleBackgroundResource(R.drawable.dashboard_ponteiro_disable);
				setValueRange(-90, -5);
				setAngleRange(0, 225);
				break;
...
//			default:
//				setGaugeBackgroundResource(R.drawable.velocimetro_2g);
//				setNeedleBackgroundResource(R.drawable.ponteiro45);
//				setValueRange(-115, -65);
//				setAngleRange(0, 180);
//				break;
		}
	}
	...
	{
		final String method = "setCurrentValue";
		
		MyLogger.debug(logger, method, "value :"+value);
		...
		MyLogger.debug(logger, method, "currentAngle :"+currentAngle+" currentValue :"+currentValue);
		

		if (this.type == GaugeType.MobileNetwork2G)
		{
			MyLogger.debug(logger, method, "MobileNetwork2G");
		...
		{
			MyLogger.debug(logger, method, "MobileNetwork3G");
		...
		{
			MyLogger.debug(logger, method, "MobileNetwork4G");
		...
		{
			MyLogger.debug(logger, method, "WifiSignalLevel");
...
//				currentDegrees = previousAngle + (currentAngle - previousAngle) * interpolatedTime;
				// currentValue = (((currentDegrees - minAngle) * (maxValue -
				// minValue)) / (maxAngle - minAngle)) + minValue;
//				if (NDL != null)
