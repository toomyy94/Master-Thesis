...
public class SendMailTaskJsonResult extends TaskJsonResult implements ITaskResult, Serializable{
	...
	private final static Logger logger = LoggerFactory.getLogger(SendMailTaskJsonResult.class);

	private String mail_data;
	private String data_size;
	private String destination_address;

	public SendMailTaskJsonResult(String task_id, String task_name,
			String macro_id, String task_number, String iccid, String cell_id,
			String loc_gps, String status, Date dateini, Date datefim, String mail_data, 
			String data_size, String destination_address, MyLocation taskLocation, EConnectionTechnology execution_in_technology) {
		...
		final String method = "SendMailTaskJsonResult";
		...
		try {
			...
			MyLogger.debug(logger, method, "mail_data :"+mail_data);
			MyLogger.debug(logger, method, "data_size :"+data_size);
			MyLogger.debug(logger, method, "destination_address :"+destination_address);
	...
	public String buildTaskJsonResult() {
		...
		try {
			...
			sb.append("\"mail_data\":\""+mail_data+"\",");
			sb.append("\"data_size\":\""+data_size+"\",");
	...
	public Map<String, String> get_task_results(Context context) {
		...
		try {
			...
			task_result_list.put(context.getString(R.string.task_result_email_to_send), mail_data);
			task_result_list.put(context.getString(R.string.task_result_data_size), data_size);
			task_result_list.put(context.getString(R.string.task_result_destination_address), destination_address);
	...
	public Object clone() {
		...
		try {
			...
			return new SendMailTaskJsonResult(super.task_id, super.task_name, super.macro_id, super.task_number, super.iccid, 
					super.cell_id, super.loc_gps, super.status, super.dateini, super.datefim, this.mail_data,
					this.data_size, this.destination_address,(MyLocation) super.taskLocation.clone(), super.execution_in_technology);
