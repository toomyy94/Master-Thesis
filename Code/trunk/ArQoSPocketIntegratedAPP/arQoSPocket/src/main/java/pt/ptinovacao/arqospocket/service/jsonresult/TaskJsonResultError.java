...
public class TaskJsonResultError extends TaskJsonResult implements ITaskResult, Serializable{

	private static final long serialVersionUID = 1L;

	private final static Logger logger = LoggerFactory.getLogger(TaskJsonResultError.class);
	
	public TaskJsonResultError(Date dateini, Date datefim, MyLocation taskLocation, 
			EConnectionTechnology execution_in_technology) {
		
		super("", "", "", "", "", "", "", "NOK", dateini, datefim, taskLocation, execution_in_technology);
	}
	
	public TaskJsonResultError(String task_id, String task_name, String macro_id, 
			String task_number, String iccid, String cell_id, String loc_gps,
			Date dateini, Date datefim, MyLocation taskLocation, 
			EConnectionTechnology execution_in_technology) {
		
		super(task_id, task_name, macro_id, task_number, iccid, cell_id, loc_gps, "NOK", 
				dateini, datefim, taskLocation, execution_in_technology);
	}
	...
	public Object clone() {
		...
		try {
			...
			return new TaskJsonResultError(super.task_id, super.task_name, super.macro_id, super.task_number, super.iccid, 
					super.cell_id, super.loc_gps, super.dateini, super.datefim, 
