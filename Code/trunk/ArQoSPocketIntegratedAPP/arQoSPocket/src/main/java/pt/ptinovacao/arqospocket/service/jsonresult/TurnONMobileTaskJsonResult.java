...
public class TurnONMobileTaskJsonResult extends TaskJsonResult implements ITaskResult, Serializable{
	...
	public TurnONMobileTaskJsonResult(String task_id, String task_name,
	...
	public Object clone() {
		...
		try {
			...
			return new TurnONMobileTaskJsonResult(super.task_id, super.task_name, super.macro_id, super.task_number, super.iccid, 
