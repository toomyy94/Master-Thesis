...
/**
 * Turn off mobile executable task.
 * <p>
 * Created by Emílio Simões on 10-04-2017.
 */
public class TurnOffMobileExecutableTask extends BaseExecutableTask {

    public TurnOffMobileExecutableTask(TaskData taskData) {
        super(taskData);
    }
