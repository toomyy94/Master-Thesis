...
/**
 * Disassociate wifi executable task.
 * <p>
 * Created by Emílio Simões on 10-04-2017.
 */
public class DisassociateWiFiExecutableTask extends BaseExecutableTask {

    public DisassociateWiFiExecutableTask(TaskData taskData) {
        super(taskData);
    }
