...
/**
 * Wifi Auth logout executable task.
 * <p>
 * Created by Emílio Simões on 10-04-2017.
 */
public class WifiAuthLogoutExecutableTask extends BaseExecutableTask {

    public WifiAuthLogoutExecutableTask(TaskData taskData) {
        super(taskData);
    }
