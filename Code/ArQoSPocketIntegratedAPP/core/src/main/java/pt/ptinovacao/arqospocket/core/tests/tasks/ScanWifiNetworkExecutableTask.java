...
/**
 * Scan network executable task.
 * <p>
 * Created by Emílio Simões on 10-04-2017.
 */
public class ScanWifiNetworkExecutableTask extends BaseExecutableTask {

    public ScanWifiNetworkExecutableTask(TaskData taskData) {
        super(taskData);
    }
