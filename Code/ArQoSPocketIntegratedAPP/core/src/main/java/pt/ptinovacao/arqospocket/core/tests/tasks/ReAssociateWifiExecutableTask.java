...
/**
 * Re-associate wifi executable task.
 * <p>
 * Created by Emílio Simões on 10-04-2017.
 */
public class ReAssociateWifiExecutableTask extends BaseExecutableTask {

    public ReAssociateWifiExecutableTask(TaskData taskData) {
        super(taskData);
    }
