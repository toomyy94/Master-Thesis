...
/**
 * Wifi Auth login executable task.
 * <p>
 * Created by Emílio Simões on 10-04-2017.
 */
public class WifiAuthLoginExecutableTask extends BaseExecutableTask {

    public WifiAuthLoginExecutableTask(TaskData taskData) {
        super(taskData);
    }
